 ...
 * @author huyhi
 */
public class SaveOrderDialog extends javax.swing.JDialog {

    /**
     * Creates new form CheckOutDialog
     */
    public SaveOrderDialog() {
        initComponents();
    ...
    private void initComponents() {
        ...
        tblSaveOrder = new javax.swing.JTable();
        ...
        jLabel2.setText("LƯU HOÁ ĐƠN");

        tblSaveOrder.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null},
                {null, null, null},
                {null, null, null},
        ...
        jScrollPane1.setViewportView(tblSaveOrder);
        if (tblSaveOrder.getColumnModel().getColumnCount() > 0) {
            tblSaveOrder.getColumnModel().getColumn(1).setMinWidth(70);
            tblSaveOrder.getColumnModel().getColumn(1).setMaxWidth(70);
        }
    ...
    private javax.swing.JTable tblSaveOrder;
